...
//
// * gameplay loops through the inner states, beginning at TURN_START and
//   terminating at TURN_END.
...
// * in the TURN_END state, if there are no tiles left to place (and after the
