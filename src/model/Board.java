...
public class Board {
     ...
     * 
     * @param tileToPlace The tile which is to be placed.
     * @param xPos The x position the tile is to be placed on the board.
     * @param yPos The y position the tile is to be placed on the board.
     ...
     * 
     * @param aPlayer The player which is placing the meeple.
     * @param xBoard The x position the meeple is to be placed on the board.
     ...
     * terrain/feature.
     * 
     * @param xBoard The x board position to start the search at.
     * @param yBoard The y board position to start the search at.
     * @param xTile The x tile position to start the search at.
     * @param yTile The y tile position to start the search at.
     ...
     * This function returns whether a meeple may be placed on the game board.
     * 
     * @param searched A HashSet containing any searched tiles.
     * @param toSearch A HashSet containing any tiles to be searched.
     * @return A boolean indicating whether the terrain is free to be claimed.
     */
     ...
     * 
     * @param aTile The tile to check for the meeple.
     * @param xPos The x position to check for the meeple.
     * @param yPos The y position to check for the meeple.
     ...
     * 
     * @param aTile The tile to search for on the game board.
     ...
     * 
     * @param hasGameEnded True if scoring at the end of the game, false if
     ...
     * 
     * @param hasGameEnded A boolean indicating whether the game has ended.
     */
     ...
     * the feature.
     * 
     * @param meeplesOnFeature An ArrayList of meeples which are on the feature.
     ...
     * 
     * @param scoreTileType The tile type to score for.
     * @param hasGameEnded A boolean indicating whether the game has ended.
     */
     ...
     * 
     * @param searched A HashSet of Strings of board & tile coordinates which
     *            have been used.
     * @param toSearch A HashSet of Strings of board & tile coordinates which
     *            are to be searched.
     * @param featureProperties An array of objects containing an ArrayList of
     *            meeples which have claimed the feature, the number of tiles
     *            which comprise the feature, and a boolean indicating the
     *            presence of a null tile.
     */
     ...
     * 
     * @param searched A set of previously searched game board coordinates.
     * @param toSearch A set of game board coordinates to be searched.
     * @param cities A list of sets of coordinates which comprise a city.
     * @param incompleteCities A list of integers corresponding to any cities in
     *            the 'cities' parameter which are incomplete.
     */
     ...
     * @param searched A set of previously searched game board coordinates.
     * @param toSearch A set of game board coordinates to be searched.
     * @param meeplesOnFeature A list of meeples which are found on the feature.
     * @param allCities A list of all completed cities in the game (sets of
     *            coordinates).
     * @param adjacentCities A list of the adjacent completed cities to the
     *            feature being searched (sets of coordinates).
     * @param featureProperties An object array used to hold the number of
     *            cities adjacent to the searched feature.
     */
    private void fieldScoreRecursive(HashSet<String> searched,
        HashSet<String> toSearch, ArrayList<Meeple> meeplesOnFeature,
        ArrayList<HashSet<String>> allCities,
        ArrayList<HashSet<String>> adjacentCities, Object[] featureProperties) {
        // Take a position from the toSearch map to search.
        String tilePosition = toSearch.toArray(new String[0])[0];
        String[] tilePos = tilePosition.split(",");
     ...
     * tiles if needed.
     * 
     * @param xBoard An x position on the board.
     * @param yBoard An y position on the board.
     * @param xTile An x tile position on the board.
     * @param yTile An y tile position on the board.
